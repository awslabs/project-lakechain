...
The Anthropic text processor allows you to leverage large-language models provided by [Anthropic](https://www.anthropic.com/) on Amazon Bedrock within your pipelines.
