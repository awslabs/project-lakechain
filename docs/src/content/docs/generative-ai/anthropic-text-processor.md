...
<span class="language-icon" style="margin-right: 10px">
  <a target="_blank" href="https://docs.aws.amazon.com/bedrock/latest/userguide/model-parameters-claude.html">
    <img src="/project-lakechain/src/assets/icon-anthropic.svg" width="31" style="border-radius: 50%" />
  </a>
</span>
...
The Anthropic text processor is part of the Bedrock text processors and allows you to leverage large-language models provided by [Anthropic](https://www.anthropic.com/) within your pipelines.
