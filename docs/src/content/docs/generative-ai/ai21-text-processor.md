...
<span class="language-icon" style="margin-right: 10px">
  <a target="_blank" href="https://docs.aws.amazon.com/bedrock/latest/userguide/model-parameters-jurassic2.html">
    <img src="/project-lakechain/src/assets/icon-ai21.svg" width="31" style="border-radius: 50%" />
  </a>
</span>
