...
import icon from '../../../assets/icon-meta.svg';
...
The Llama text processor allows you to leverage the [Llama family](https://llama.meta.com/) of large-language models provided by [Meta](https://ai.meta.com/meta-ai/) on Amazon bedrock within your pipelines.
...
- [Llama Summarization Pipeline](https://github.com/awslabs/project-lakechain/tree/main/examples/simple-pipelines/summarization-pipelines/llama-summarization-pipeline) - Builds a pipeline for text summarization using Llama models on Amazon Bedrock.
