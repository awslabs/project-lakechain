...
The Titan text processor allows you to leverage [Amazon Titan](https://aws.amazon.com/bedrock/titan/) machine-learning models on Amazon Bedrock within your pipelines.
...
- [Titan Summarization Pipeline](https://github.com/awslabs/project-lakechain/tree/main/examples/simple-pipelines/summarization-pipelines/titan-summarization-pipeline) - Builds a pipeline for text summarization using Amazon Titan models on Amazon Bedrock.
