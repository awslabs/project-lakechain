...
- [Titan Background Removal Pipeline](https://github.com/awslabs/project-lakechain/tree/main/examples/simple-pipelines/image-processing-pipelines/titan-image-background-removal-pipeline) - Builds a pipeline demonstrating image background removal using the Amazon Titan model.
