...
> ℹ️ The below example demonstrates how to use the SDXL image generator to create images from an arbitrary prompt every 5 minutes, using the [Scheduler Trigger](/triggers/scheduler-event-trigger).
