...
- [Knowledge Graph Pipeline](https://github.com/awslabs/project-lakechain/tree/main/examples/simple-pipelines) - Builds a pipeline for semantic ontology extraction from documents.
