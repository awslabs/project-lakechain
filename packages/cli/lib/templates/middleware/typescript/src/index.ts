...
/**
 * Builder for the `SimpleTextProcessor` middleware.
 */
class SimpleTextProcessorBuilder extends MiddlewareBuilder {

  /**
   * @returns a new instance of the `SimpleTextProcessor`
   * service constructed with the given parameters.
   */
  public build(): SimpleTextProcessor {
...
/**
 * An example middleware based on a Lambda compute.
 * This middleware processes text documents by counting
 * the number of words in the document. Feel free to modify
 * and adapt this middleware to your needs.
 */
export class SimpleTextProcessor extends Middleware {
