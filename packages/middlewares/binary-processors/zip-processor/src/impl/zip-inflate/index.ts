...
/**
 * The builder for the `ZipInflateProcessor` middleware.
 */
class ZipInflateProcessorBuilder extends MiddlewareBuilder {

  /**
   * @returns a new instance of the `ZipInflateProcessor`
   * service constructed with the given parameters.
   */
  public build(): ZipInflateProcessor {
...
/**
 * A middleware providing a way to unzip compressed
 * archives from a source bucket into a destination
 * bucket.
 */
export class ZipInflateProcessor extends Middleware {
  ...
  /**
   * The builder for the `ZipInflateProcessor` service.
   */
  public static readonly Builder = ZipInflateProcessorBuilder;
