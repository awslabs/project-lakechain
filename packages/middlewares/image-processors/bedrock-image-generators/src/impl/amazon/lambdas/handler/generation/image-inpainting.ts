...
import { ImageInpaintingProps } from '../../../definitions/tasks';
...
/**
 * Executes the given image inpainting task.
 ...
 * buffers.
 */
export const imageInpainting = async (event: CloudEvent, model: string, task: ImageInpaintingProps) => {
