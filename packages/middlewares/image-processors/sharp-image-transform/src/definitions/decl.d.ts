...
import * as dsl from '@project-lakechain/core/dsl/vocabulary/reference';
...
declare namespace sharp {
    ...
    interface OverlayOptions extends SharpOptions {
        ...
        input?: string | Buffer | { create: Create } | { text: CreateText } | { raw: CreateRaw } | dsl.IReference<dsl.IReferenceSubject> | undefined;
