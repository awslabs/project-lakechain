...
import { z } from 'zod';
import { TitanTextModel } from './model';
...
/**
 * Titan text processor properties schema.
 */
export const TitanTextProcessorPropsSchema = TextProcessorPropsSchema.extend({

  /**
   * The text model to use.
   */
  model: z.instanceof(TitanTextModel),
...
// The type of the `TitanTextProcessorProps` schema.
export type TitanTextProcessorProps = z.infer<typeof TitanTextProcessorPropsSchema>;
