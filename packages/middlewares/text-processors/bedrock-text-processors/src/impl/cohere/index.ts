...
import {
  CohereTextProcessorProps,
  CohereTextProcessorPropsSchema,
  ModelParameters
 ...
 */
class CohereTextProcessorBuilder extends MiddlewareBuilder {
  private middlewareProps: Partial<CohereTextProcessorProps> = {};
   ...
   */
  public withModel(model: CohereTextModel) {
   ...
   */
  public build(): CohereTextProcessor {
...
/**
 * A service providing text generation using Cohere models
 * on Amazon Bedrock.
 */
export class CohereTextProcessor extends Middleware {
   ...
   */
  constructor(scope: Construct, id: string, private props: CohereTextProcessorProps) {
...
export { CohereTextModel } from './definitions/model';