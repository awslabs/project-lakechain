...
import {
  AnthropicTextProcessorProps,
  AnthropicTextProcessorPropsSchema,
  ModelParameters
 ...
 */
class AnthropicTextProcessorBuilder extends MiddlewareBuilder {
  private middlewareProps: Partial<AnthropicTextProcessorProps> = {};
   ...
   */
  public withModel(model: AnthropicTextModel) {
   ...
   */
  public build(): AnthropicTextProcessor {
...
/**
 * A service providing text generation using Anthropic models
 * on Amazon Bedrock.
 */
export class AnthropicTextProcessor extends Middleware {
   ...
   */
  constructor(scope: Construct, id: string, private props: AnthropicTextProcessorProps) {
...
export { AnthropicTextModel } from './definitions/model';