...
const description: ServiceDescription = {
  name: 'amazon-titan-embedding-processor',
  description: 'Creates embeddings from documents using Amazon Titan models.',
  version: '0.7.0',
  attrs: {}
};
 ...
 */
class TitanEmbeddingProcessorBuilder extends MiddlewareBuilder {
  private providerProps: Partial<BedrockEmbeddingProps> = {};
