 ...
 * user provided conditional statement to determine how to
 * reduce events.
 */
export class ConditionalStrategyConstruct extends Construct {
   ...
   */
  public evaluationFn: lambda.IFunction;
