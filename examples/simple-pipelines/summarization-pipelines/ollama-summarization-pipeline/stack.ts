 ...
 * text using the Ollama Processor middleware.
 ...
 *    |                                             ▼
 * ┌──────────────┐   ┌────────────────────┐   ┌────────┐   ┌─────────────┐
 * │   S3 Input   ├──►│  Pandoc Converter  ├──►│ Ollama ├──►│  S3 Output  │
 * └──────────────┘   └────────────────────┘   └────────┘   └─────────────┘
 *
 */
export class OllamaSummarizationStack extends cdk.Stack {
...
// Deploy the stack.
new OllamaSummarizationStack(app, 'OllamaSummarizationStack', {
  env: {
    account,
    region
  }
