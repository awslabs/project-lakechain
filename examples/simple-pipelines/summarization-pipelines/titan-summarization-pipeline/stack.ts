 ...
 * to summarize text using the Amazon Titan model.
 ...
 *
 */
export class TitanSummarizationPipeline extends cdk.Stack {
...
// Deploy the stack.
new TitanSummarizationPipeline(app, 'TitanSummarizationPipeline', {
  env: {
    account,
    region
  }
