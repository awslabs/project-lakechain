...
We've created a handy CLI tool, called the [RAG CLI](../../../tools/cli/), that you can use to run the retrieval step of the RAG pipeline. Before using it, prepare the following information that we will need to feed to the CLI.
...
Once done, head with your terminal to the [`cli`](../../../tools/cli/) directory and install the dependencies of the CLI:
